# VAYLORN 5.2.1 Spawn Density QA

## 자동 회귀 검사

- 최대 동시 몬스터 12마리와 일반 웨이브 초기 8마리 상수 검사
- 신규 몬스터가 x=710 이하의 가시 전투 진입선에서 생성되는지 검사
- 8개 고정 프레임 안에 빈 전투 슬롯이 12마리까지 보충되는지 검사
...
- 360×780 첫 프레임 캡처: [QA-v5.2.1-spawn-density-first-frame.png](QA-v5.2.1-spawn-density-first-frame.png)
